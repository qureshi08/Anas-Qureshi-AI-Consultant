...
const LINKEDIN_LOCATIONS = ['Pakistan', 'Worldwide', 'United Arab Emirates', 'Saudi Arabia', 'Canada'];
...
const APPLICANT_DETAIL_BUDGET = 25;
...
export async function fetchAndStoreJobs({ days = 3, minScore = 3, linkedin = true, ats = true, budgetMs = 50000 } = {}) {
  ...
  const now = Date.now();
  const dropped = { stale: 0, location: 0, pay: 0, score: 0, dupe: 0, buried: 0 };
