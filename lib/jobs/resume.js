...
export const RESUME_FILES = {
  ...
  ai: { label: 'AI Automation Engineer', path: '/resume/Anas_Qureshi_AI_Automation_Engineer.pdf' },
  data: { label: 'Data Analytics Engineer', path: '/resume/Anas_Qureshi_Data_Analytics_Engineer.pdf' },
};
export const ANSWERS = [
  ['Full name (legal)', 'Muhammad Anas'],
  ['Preferred name', 'Anas Qureshi'],
...
export const RESUME_TEXT = `Anas Qureshi (legal name Muhammad Anas)
...
AI Consultant at Convergent Business Technologies since 2024, building AI features, integrations and multi tenant backends into client systems in banking, retail, marketing analytics and higher education (NCICU).
...
QA and UAT Lead, NCICU Data Portal (North Carolina Independent Colleges and Universities) | 2026
