...
export const RESUME_FILES = {
  // No static PDF for the Solutions Engineer variant: every application gets the tailored PDF
...
export const ANSWERS = [
  ...
  ['Headline', 'AI Solutions Engineer | LLM Apps, Workflow Automation, API Integrations, Python, Next.js'],
  ['Short bio (3 lines)', 'AI Consultant at Convergent Business Technologies since 2024, building automation and AI systems that remove manual work from finance, compliance and recruiting workflows with Python, SQL, n8n and LLMs. Shipped a production recruitment portal on Next.js and Supabase, and an end to end AI assisted retail reporting pipeline (UAE and KSA) that cut the full monthly refresh from 7 days to about 2 hours. Automated workflows have reduced processing time by 60 to 75 percent.'],
];
...
AI Solutions Engineer | LLM Apps, Workflow Automation, API Integrations, Python, Next.js
...
Summary
AI Consultant at Convergent Business Technologies since 2024, building automation and AI systems that remove manual work from finance, compliance and recruiting workflows using Python, SQL, n8n and LLMs. Shipped a production recruitment portal on Next.js and Supabase, and an end to end AI assisted retail reporting pipeline (UAE and KSA) that cut the full monthly refresh from 7 days to about 2 hours. Automated workflows have reduced processing time by 60 to 75 percent.
...
PepsiCo Retail Analytics, UAE and KSA, 2024. Python, Tableau, Gemini, Docker, Excel. Built an end to end monthly reporting pipeline for UAE and KSA retail data, harmonizing SKU level sales, quantity, volume, manufacturer and competitor detail across 13 retailers into one role based platform. Automated SKU matching using Python and AI assisted logic as one step in the pipeline, reducing matching time from 80 minutes to 40 seconds per 100 SKUs, accuracy up from 70 to 95 percent. Automated the full monthly refresh, database push, Tableau dashboard rebuild, and Excel report generation, with all numbers validated automatically. Cut the full monthly reporting cycle from 7 days to about 2 hours, and data validation turnaround from 3 days to 1. Containerized workflows with Docker.
