...
const STRONG = /chart|visuali[sz]|dashboard|data analy|statistic|quantitative|financ|econom|risk|accounting|python|\bsql\b|coding|code review|software|data scien|machine learning|\bllm\b|prompt|reasoning|urdu|business analy|analytics/i;
const MILD = /evaluat|rater|rating|annotat|label|ai trainer|ai training|subject matter|expert|task author/i;
const DROP = /japanese|korean|spanish|chinese|mandarin|cantonese|italian|french|german|portuguese|russian|arabic|hindi|bengali|turkish|vietnamese|thai|indonesian|polish|dutch|swedish|norwegian|danish|finnish|greek|hebrew|farsi|persian|tagalog|swahili|nurs|physician|clinical|pharmac|dentist|veterinar|\blaw\b|legal|attorney|chemistr|biolog|physics|mechanical|electrical|civil eng|architect|music|film|television|producer|teacher|sociolog|psycholog|photograph|audio|video|voice|speech|recording|translation|translator/i;
