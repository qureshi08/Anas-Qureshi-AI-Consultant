...
const SYSTEM = `You write job application copy for Muhammad Anas. You are given his resume (the ONLY allowed source of facts about him) and one job posting. Return strict JSON with keys: fit_note, resume_variant, cover_note, dm_text.
