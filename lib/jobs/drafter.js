...
- dm_text: Anas has no LinkedIn Premium, this is a connection request note, not a message, hard capped at 300 characters. 20 to 30 words maximum. "Hi <first name>," if the founder is named, then one short line naming what they build and the barest hint of the pitch, nothing more, there is no room for proof or numbers here, that goes in the email. No links, no dashes.
