...
export const HEADLINES = {
  // Default since 2026-09-25: the job stream targets AI / Solutions Engineer roles only.
  se: 'AI Solutions Engineer | LLM Apps, Workflow Automation, API Integrations, Python, Next.js',
...
export const PROJECTS = [
  ...
  },
  {
    ...
    tags: 'llm fine tuning data analytics tableau dashboards docker accuracy pipeline retail reporting',
    bullets: [
      ...
      'Automated the full monthly refresh, database push, Tableau dashboard rebuild, and Excel report generation, with all numbers validated automatically before delivery to decision makers',
...
export const DEFAULT_ORDER = {
  se: ['consultant', 'portal', 'recruiting_automation', 'pepsico', 'zatca', 'ztbl'],
