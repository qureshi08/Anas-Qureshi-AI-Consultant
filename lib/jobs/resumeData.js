...
// Every bullet below is traced to Anas's own work files (survey of his work folder, 2026-09-26). Confidential
// client names (the bank, the US college consortium) stay generic. Source of truth: Jobs/resume/resume_source.md.
export const PROJECTS = [
  ...
  {
    id: 'qa', name: 'QA and UAT Lead, US Higher Education Data Portal', year: '2026',
