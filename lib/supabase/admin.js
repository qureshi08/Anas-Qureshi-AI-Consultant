...
export function createAdminClient() {
  return createClient(
    ...
    process.env.SUPABASE_SERVICE_ROLE,
    {
      ...
      // Always read fresh. Next.js caches server fetches, so without no-store /v/<slug> kept serving an old
      // video_url after the row changed (2026-09-26, Memorable), and view counts could read stale too.
